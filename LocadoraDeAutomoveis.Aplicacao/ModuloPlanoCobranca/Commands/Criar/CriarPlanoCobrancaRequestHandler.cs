...
public class CriarPlanoCobrancaRequestHandler : IRequestHandler<CriarPlanoCobrancaRequest,object>
{
    ...
    public async Task<object> Handle(CriarPlanoCobrancaRequest request, CancellationToken cancellationToken)
    {
